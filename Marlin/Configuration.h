...
#define STRING_CONFIG_H_AUTHOR "(Mathias G. Ovesen -  Ender 3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mathias' 3D Printer"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "8fccb4ae-b407-4b11-9fd7-0670727f8609"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 169.61
  #define DEFAULT_bedKi 33.14
  #define DEFAULT_bedKd 578.60
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 2560, 277 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 4, 100 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 150, 4000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -2.85 }
...
#define EVENT_GCODE_AFTER_HOMING "G27"  // Commands to run after G28 (and move to XY_AFTER_HOMING)
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      83    // (°C) Default bed temperature for G26.
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.00625 // (mm) Step size while manually probing Z axis.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_MENU              // Adds Park Head to LCD Menu
#endif
