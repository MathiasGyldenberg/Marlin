...
//
  ...
  #define TEMP_BOARD_PIN         PA3 // Board temp sensor pin override.
#endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_MIN_BOARD_TEMP 35  // (°C) Turn on the fan if the board reaches this temperature
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 122  // Define here to override the defaults below
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 190,  20 }, { 190, 190 }, { 20, 190 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SD_FINISHED_RELEASECOMMAND "G27 I3"  // Use "M84XYE" to keep Z enabled so your bed stays in place
  ...
  #define EVENT_GCODE_SD_ABORT "G27 I3"        // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.06 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT   15  // (mm^3/sec)
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX       40  // (mm^3/sec)
  #endif
#endif
...
#define G0_FEEDRATE 6000 // (mm/min)
#ifdef G0_FEEDRATE
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_FEEDRATE_START   240     // Feedrate before correction move (mm/min)
  //#define GANTRY_CALIBRATION_TO_MIN                 // Enable to calibrate Z in the MIN direction

  #define GANTRY_CALIBRATION_SAFE_POSITION XY_CENTER // Safe position for nozzle
  #define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 3000  // XY Park Feedrate - MMM
  //#define GANTRY_CALIBRATION_COMMANDS_PRE   ""
  #define GANTRY_CALIBRATION_COMMANDS_POST  "G0 Z25 F240\nG28"     // G28 highly recommended to ensure an accurate position
#endif
